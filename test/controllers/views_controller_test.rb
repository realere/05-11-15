...
class ViewsControllerTest < ActionController::TestCase
  ...
  test "should create view" do
    assert_difference('View.count') do
      post :create, view: { movie_id: @view.movie_id, place_of_viewing: @view.place_of_viewing, review: @view.review, user_id: @view.user_id }
    end
  ...
  test "should update view" do
    patch :update, id: @view, view: { movie_id: @view.movie_id, place_of_viewing: @view.place_of_viewing, review: @view.review, user_id: @view.user_id }
    assert_redirected_to view_path(assigns(:view))
  end
