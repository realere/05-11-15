...
ActiveRecord::Schema.define(version: 20151105003820) do
  ...
  add_index "movies_users", ["user_id", "movie_id"], name: "index_movies_users_on_user_id_and_movie_id", using: :btree
